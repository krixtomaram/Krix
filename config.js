...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'VENOMOUS',
    ...
    BOT_INFO: process.env.BOT_INFO || 'LYGOPHILE;KRIXTOM;919365354223;https://i.imgur.com/6oRG106.jpeg',

    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'LYGOPHILE;KRIXTOM;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,

    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'LYGOPHILE 💋;KRIXTOM' : process.env.STICKER_DATA,
